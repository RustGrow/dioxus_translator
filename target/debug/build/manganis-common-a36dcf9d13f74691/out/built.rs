...
#[allow(dead_code)]
pub const PKG_AUTHORS: &str = r"Evan Almloff";
#[doc=r#"The name of the package."#]
#[allow(dead_code)]
pub const PKG_NAME: &str = r"manganis-common";
#[doc=r#"The description."#]
#[allow(dead_code)]
pub const PKG_DESCRIPTION: &str = r"Ergonomic, automatic, cross crate asset collection and optimization";
#[doc=r#"The homepage."#]
#[allow(dead_code)]
pub const PKG_HOMEPAGE: &str = r"https://dioxuslabs.com";
#[doc=r#"The license."#]
#[allow(dead_code)]
pub const PKG_LICENSE: &str = r"MIT OR Apache-2.0";
#[doc=r#"The source repository as advertised in Cargo.toml."#]
#[allow(dead_code)]
pub const PKG_REPOSITORY: &str = r"https://github.com/DioxusLabs/manganis/";
